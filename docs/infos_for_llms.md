...
v0.7.8 is a quality-first reset. Do not reintroduce independently random per-track composition. The generator must keep one shared song plan: sections, mode, progression, chord map, phrase contour and rhythm grid. Tracks are projections of that plan.
...
## v0.7.8 intro and multi-melody rule
...
## v0.7.8 bass/instrument variation rule
...
## v0.7.8 prompt-first architecture
...
## v0.7.8 Prompt style enforcement
...
## v0.7.8 multi-style prompt blend rule
...
## v0.7.8 prompt-style priority rule
